    ...
    private void initViews(){
        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /* Toast with payment fail data */
                if(mInputMoney.getText().toString().isEmpty() || mInputInfo.getText().toString().isEmpty()) {
                    Toast.makeText(CheckActivity.this, R.string.payment_fail, Toast.LENGTH_LONG).show();
                    return;
                }

                /* Toast with payment info */
                @SuppressLint("StringFormatMatches")
                String message = String.format(
                        getString(R.string.payment_complete),
